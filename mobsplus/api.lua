...
function mobs:register_mob(name, def)
	minetest.register_entity(name, {
		...
		on_step = function(self, dtime)
			...
			--Remove mobs in areas they aren't allowed
		
			local npos = self.object:getpos()
			if areas:getAllowedMobs(npos) == "none" then
				self.object:remove()
			elseif areas:getAllowedMobs(npos) == "peaceful" and self.type == "monster" then
				self.object:remove()
			elseif areas:getAllowedMobs(npos) == "hostile" and self.type == "animal" then 
				self.object:remove()
			elseif areas:getAllowedMobs(npos) == "hostile" and self.type == "clucky" then 
				self.object:remove()
			end
...
mobs.spawning_mobs = {}
function mobs:register_spawn(name, nodes, max_light, min_light, chance, active_object_count, max_height, type, spawn_func)
	...
	minetest.register_abm({
		...
		action = function(pos, node, _, active_object_count_wider)
			...
			--check if areas 
		--	if areas:getAllowedMobs(pos) == "all" then
			--	chnce = areas:getSpawnChance(pos)
			--elseif areas:getAllowedMobs(pos) == "peaceful" then
			--	chnce = areas:getSpawnChance(pos)
			--elseif areas:getAllowedMobs(pos) == "hostile" then 
			--	chnce = areas:getSpawnChance(pos)
			--end
		--	local spawnableType = "all"
			--if areas:getAllowedMobs(pos) == "none" then
				--return
		--	elseif areas:getAllowedMobs(pos) == "all" then
			--	spawnableType = "all"
			--elseif areas:getAllowedMobs(pos) == "peaceful" then
			--	spawnableType = "peaceful"
			--elseif areas:getAllowedMobs(pos) == "hostile" then 
				--spawnableType = "hostile"
		--	end
			
			--if spawnableType == "all" or type == spawnableType then	
...
function mobs:register_egg(modname, mobname, mobdesc)
